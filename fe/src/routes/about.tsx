				...
				<div className="space-y-8">
					<section className="bg-card rounded-2xl border p-8 shadow-sm">
						...
						<p className="text-muted-foreground text-lg leading-relaxed">
							This is an open-source admin dashboard starter built with modern
							web technologies. It provides a solid foundation for building
							powerful admin interfaces and dashboards. The source code is
							freely available for developers to use, modify, and distribute.
						</p>
					</section>
					<section className="bg-card rounded-2xl border p-8 shadow-sm">
						<h2 className="text-foreground mb-4 text-xl font-semibold">
